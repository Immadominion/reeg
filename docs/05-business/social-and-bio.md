...
**The proof flex**
> "Verified" should mean something. With Reeg you can close our app entirely and verify a
> run's full history offline, from public Sui + Walrus data alone. No backend in the trust
> path. GitHub history can be rewritten. This can't.
