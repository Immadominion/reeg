 ...
 * legitimate checkpoint (the moment an operator most needs the snapshot to land); only a confirmed
 * retirement returns true. REEG_DEBUG surfaces the swallowed error.
 */
